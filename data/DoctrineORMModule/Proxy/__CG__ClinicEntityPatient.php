 ...
 */
class Patient extends \Clinic\Entity\Patient implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'email', 'name', 'surname', 'joined', 'password', 'verified', 'appointments');
        }
